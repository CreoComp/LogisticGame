...
public class PointInRoute: MonoBehaviour
{
    ...
    public void ConstructStation(DrawRoute drawRoute, PointInfo pointInfo, Sprite circleSprite, float size = 0.2f, bool isLastPoint = false)
    {
        _drawRoute = drawRoute;
        _pointInfo = pointInfo;
        _circleSprite = circleSprite;
        ...
        switch (pointInfo.StationInfo.StationType)
        {
        ...
        gameObject.GetComponent<Station>()._imageLogo.sprite = Resources.Load<Sprite>("Station/" + pointInfo.StationInfo.LogoName);
